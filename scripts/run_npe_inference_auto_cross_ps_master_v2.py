#!/usr/bin/env python3
"""
NPE Inference with Auto + Cross Power Spectra (MASTER-corrected) - v2 (Refactored)

This is a refactored version that uses modular bar_impact utilities:
- bar_impact.utils.inference: TARP testing and plotting functions

Changes from original:
- Eliminated run_tarp_coverage_test() (~80 lines) - now uses utils.inference.run_tarp_coverage_test()
- Eliminated plot_tarp_coverage() (~60 lines) - now uses utils.inference.plot_tarp_coverage()
...
This script eliminates ~140 lines of duplicated TARP testing code while maintaining all
specialized power spectra processing functionality.
...
# ==============================
# REFACTORED SECTION:
# run_tarp_coverage_test() and plot_tarp_coverage() functions (~140 lines)
# have been REMOVED and replaced with imports from bar_impact.utils.inference
# ==============================
...
def main():
    ...
    # REFACTORED: Coverage testing now uses utils.inference functions
