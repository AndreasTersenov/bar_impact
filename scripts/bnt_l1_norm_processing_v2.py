...
def process_file(file_path, bnt_bin=3, noise_level=0.26, add_noise=True,
    ...
    if add_noise:
        suffix = f"_l1_norms_bnt{bnt_bin}{mask_suffix}_noisy_s{noise_level:.2f}_new_normalization.npy"
    else:
        suffix = f"_l1_norms_bnt{bnt_bin}{mask_suffix}_new_normalization.npy"
            ...
            if len(results) > 0:
                ...
                if args.combined_output:
                    ...
                    combined_path = os.path.join(
                        base_dir,
                        f"all_l1_norms_bnt{bnt_bin}{mask_suffix}{noise_suffix}_new_normalization.npy"
                    )
