...
CFG = dict(nside=512, mask_area=5000.0, center=(0.0, 90.0), apod_type="C2",
...
def run(args):
    ...
    bands = {"37-100": (37, 100, args.rebin),
             "100-1024": (100, 1024, args.rebin_wide),
             "37-1024": (37, 1024, args.rebin_wide)}
    results = {}
    ...
    for band in ["37-1024", "37-100", "100-1024"]:
...
def main():
    ...
    p.add_argument("--out-dir", type=str,
                   default=os.path.join(REPO, "outputs", "diagnostics", "fisher_gate_5000_l37"))
    args = p.parse_args()
    if args.pilot:
