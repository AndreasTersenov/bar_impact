...
# Variable parameters - ONLY mask_area 5000.0
FIDUCIAL_TYPES = ["nobaryons", "baryonified"]
UPPER_CUTS = list(range(520, 1021, 20))  # 520, 540, ..., 1000, 1020
MASK_AREAS = [5000.0]  # ONLY 5000.0
GPUS = [0, 1, 2]

# Log directory
LOG_DIR = Path("logs/npe_parameter_sweep_rerun_5000")
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Rerun NPE inference jobs for mask_area 5000.0")
    ...
    if RUN_NUMBER is not None:
        LOG_DIR = Path(f"logs/npe_parameter_sweep_rerun_5000_run{RUN_NUMBER}")
    ...
    print("="*80)
    print("NPE Inference Rerun - MASK_AREA 5000.0 ONLY")
    if RUN_NUMBER is not None:
