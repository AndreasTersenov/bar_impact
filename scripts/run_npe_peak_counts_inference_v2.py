#!/usr/bin/env python3
# filepath: /home/tersenov/software/bar_impact/scripts/run_npe_peak_counts_inference_v2.py
"""
NPE Inference on CosmoGRID Peak Counts - v2 (Refactored)

This is a refactored version that uses the modular bar_impact utilities:
- bar_impact.analysis.aggregation: ResultsAggregator for data loading and scale selection
...
- Uses ResultsAggregator.select_scales_per_bin() for per-bin scale selection
- Simplified file path construction using pattern matching
...
def main():
    ...
    print(f"Bin configuration: {paths['bin_spec']}")
