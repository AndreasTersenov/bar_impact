...
class TestNPEResult:
    ...
    def test_save_load(self, sample_result):
        ...
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            np.testing.assert_array_almost_equal(loaded.samples, sample_result.samples)
...
class TestNPEInference:
    ...
    def test_init_with_config(self):
        ...
        from bar_impact.inference.npe import NPEConfig, NPEInference
...
class TestCoverageResult:
    ...
    def simple_result(self):
        ...
        from bar_impact.inference.coverage import CoverageConfig, CoverageResult
    ...
    def test_ecp_mean_no_bootstrap(self, simple_result):
        ...
        np.testing.assert_array_almost_equal(simple_result.ecp_mean, simple_result.ecp)
...
class TestCoverageTester:
    ...
    def test_init_with_config(self):
        """Test initialization with custom config."""
        from bar_impact.inference.coverage import CoverageConfig, CoverageTester
...
class TestFunctionalInterface:
    ...
    def test_run_npe_inference_creates_config(self):
        ...
        config = NPEConfig(
            **{
                k: v
                for k, v in {"num_epochs": 100, "batch_size": 32}.items()
