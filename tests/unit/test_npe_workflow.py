...
class TestTrainOrLoadNPE:
    ...
    def test_train_with_nan_retry(self):
        ...
        with patch('bar_impact.utils.npe_workflow.train_npe_with_nan_retry') as mock_train:
...
class TestTrianglePlot:
    ...
    def test_create_triangle_plot_basic(self, tmp_path):
        ...
        with patch('bar_impact.utils.npe_workflow.plots') as mock_plots, \
             patch('bar_impact.utils.npe_workflow.plt') as mock_plt:
    ...
    def test_create_triangle_plot_with_fiducial(self, tmp_path):
        ...
        param_config = {
            'labels': [r"$\Omega_m$", r"$S_8$", r"$w_0$", r"$H_0$", r"$n_s$", r"$\Omega_b$"],
    ...
    def test_create_triangle_plot_creates_directory(self, tmp_path):
        ...
        with patch('bar_impact.utils.npe_workflow.plots'), \
             patch('bar_impact.utils.npe_workflow.plt'):
...
class TestSampleAndSavePosterior:
    ...
    def test_sample_and_save_basic(self, tmp_path):
        ...
        with patch('bar_impact.utils.npe_workflow.create_triangle_plot') as mock_triangle:
...
class TestSetupJAXEnvironment:
    ...
    def test_setup_jax_environment_gpu(self):
        ...
        with patch('bar_impact.utils.npe_workflow.os.environ', {}) as mock_env, \
             patch('bar_impact.utils.npe_workflow.jax.devices') as mock_devices:
    ...
    def test_setup_jax_environment_force_cpu(self):
        ...
        with patch('bar_impact.utils.npe_workflow.os.environ', {}) as mock_env, \
             patch('bar_impact.utils.npe_workflow.jax.config') as mock_config:
