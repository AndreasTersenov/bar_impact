...
Auto-generated by `scripts/paper/figures.py manifest`. **42 figures.**
...
| - | [`hos_bnt_peaks_vs_scale_cut`](hos_bnt_peaks_vs_scale_cut/) | Peak counts: BNT vs scale cut vs all scales (baryonified) | `a3f63d23f6c425f005185ba5e2ba2fb219773eeb` | 3 | **2** |
| - | [`ps_frac_diff_fig2`](ps_frac_diff_fig2/) | Fig. 2 - fractional baryonic impact on the auto power spectra (matched noise, survey band) | `2340a4ee6f6adf47706ea6e4151a94db3b307a34` | 40 | **2** |
