# contours vs area ps biased single seed with full sky

Same as contours_vs_area_ps_biased_single_seed but with a seventh, full-sky contour (black). Peaks has no counterpart: no full-sky peak-count posterior exists.
