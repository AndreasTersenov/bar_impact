# contours vs area l1 biased pooled with full sky

Same as contours_vs_area_l1_biased_pooled but with a seventh, full-sky contour (black). Peaks has no counterpart: no full-sky peak-count posterior exists.

- **source**: `outputs/plots/contours_vs_area/contours_vs_area_l1_biased_l37-1020_with_fullsky_pooled`
