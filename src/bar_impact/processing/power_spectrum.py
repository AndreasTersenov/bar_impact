...
__all__ = ["PowerSpectrumProcessor", "compute_power_spectrum", "compute_cross_power_spectrum"]
...
class PowerSpectrumProcessor(BaseProcessor):
    ...
    def __init__(
        ...
        self.ell_min = ell_min if ell_min is not None else getattr(config, 'ell_min', None)
        self.ell_max = ell_max if ell_max is not None else getattr(config, 'ell_max', None)
